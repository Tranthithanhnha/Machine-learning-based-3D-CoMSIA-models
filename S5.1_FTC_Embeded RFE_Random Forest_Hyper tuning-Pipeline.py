...
pipe = Pipeline(steps=[("scaler", StandardScaler()), ('feat_sel', RFE(estimator= RandomForestRegressor(random_state=1), step=20)),
                       ('model', RandomForestRegressor(random_state=1))])
param_grid = {
                       # specify here the number of features you want to test using the RFE method
                       'feat_sel__n_features_to_select': [5, 7,  9, 11,  13,  15, 17], 
...
rfe = RFE(RandomForestRegressor(), n_features_to_select= n_features_to_select, step=20 )
...
df_X_train.to_csv(r'C:\Users\84981\Dropbox\PC\Documents\Documents_old\Nha research_2018\FTC PROJECT\INTERATION FIELDS_FTC_197 PEPTIDES\df_X_train_S5.1.csv')


# In[32]:


y_train.to_csv(r'C:\Users\84981\Dropbox\PC\Documents\Documents_old\Nha research_2018\FTC PROJECT\INTERATION FIELDS_FTC_197 PEPTIDES\y_train_S5.1.csv')
...
df_X_test.to_csv(r'C:\Users\84981\Dropbox\PC\Documents\Documents_old\Nha research_2018\FTC PROJECT\INTERATION FIELDS_FTC_197 PEPTIDES\df_X_test_S5.1.csv')


# In[35]:


y_test.to_csv(r'C:\Users\84981\Dropbox\PC\Documents\Documents_old\Nha research_2018\FTC PROJECT\INTERATION FIELDS_FTC_197 PEPTIDES\y_test_S5.1.csv')
...
d1 = {'model__n_estimators': 'n_estimators',
