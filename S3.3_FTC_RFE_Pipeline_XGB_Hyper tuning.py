...
GridSearch_df.to_csv(r'C:\Users\84981\Dropbox\PC\Documents\Documents_old\Nha research_2018\FTC PROJECT\INTERATION FIELDS_FTC_197 PEPTIDES\GridSearch_S3.3.csv')
...
d1 = {'model__colsample_bytree':'colsample_bytree',
...
RandomSearch_df.to_csv(r'C:\Users\84981\Dropbox\PC\Documents\Documents_old\Nha research_2018\FTC PROJECT\INTERATION FIELDS_FTC_197 PEPTIDES\RandomSearch_S3.3.csv')
...
dic1 = {'model__colsample_bytree':'colsample_bytree',
        'model__learning_rate':'learning_rate',
        'model__max_depth': 'max_depth',
        'model__n_estimators':'n_estimators',
        'model__reg_alpha':'reg_alpha',
